...
function loadStatsPage(){
    ...
    {//Outer for loop iterates over each row
        buffs_value = 0;
        opp_value = 0;
        for(col_counter = 2; col_counter < table.rows[row_counter].cells.length; col_counter++)
        {
            if(col_counter == 2){
                buffs_value = table.rows[row_counter].cells[col_counter].innerHTML;
                buffs_value = parseInt(buffs_value);
            }
            if(col_counter == 3){
            ...
            if(col_counter == 4){
                if(buffs_value > opp_value){
                    table.rows[row_counter].cells[col_counter].innerHTML = "CU";
                    wins++;
                }
                else if(opp_value > buffs_value){
                    table.rows[row_counter].cells[col_counter].innerHTML = "Not CU";
                    losses++;
                }
            }
        }
...
function loadPlayersPage(){
    ...
    menu.innerHTML += "<a class='dropdown-item' href='#' onClick='switchPlayers(0)'>John Doe</a>";
    menu.innerHTML += "<a class='dropdown-item' href='#' onClick='switchPlayers(1)'>James Smith</a>";
    menu.innerHTML += "<a class='dropdown-item' href='#' onClick='switchPlayers(2)'>Samuel Phillips</a>";
    menu.innerHTML += "<a class='dropdown-item' href='#' onClick='switchPlayers(3)'>Robert Myers</a>";
}
